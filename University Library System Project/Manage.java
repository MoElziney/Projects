...
String[]dataList={""};
  ...
  DefaultListModel<String> model = new DefaultListModel<>();
     ...
     */
    public Manage() {
        dataList=b1.viewBookingList(userId);
        initComponents();
        setModelValues();
 ...
 public void setModelValues(){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List of Borrowed Materials ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        AcadimicUserDashboard d = new AcadimicUserDashboard();
        d.show();
        dispose();
    ...
    private void jList2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList2MousePressed
        ...
        data=b1.viewBookingDetail(userId,jList2.getSelectedIndex());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       if(date.before(today)){
           JOptionPane.showMessageDialog(null, "This date is unValid");
           
       }else{
           String updateDate=date.getDay()+"-"+date.getMonth()+"-"+date.getYear();
           au.manageBorrow(userId, jList2.getSelectedIndex(),updateDate);
